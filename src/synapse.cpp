...
//public:
    ...
    void Synapse::step(double t, double dt) {
    ...
    double Synapse::get_current() const {
        return syn_current;
    }

    std::string Synapse::get_type() const {
        return syn_type;
    }

    FCM* Synapse::get_post_neuron() {
      return post_neuron;
    }

    FCM* Synapse::get_pre_neuron() {
      return pre_neuron;
    }
